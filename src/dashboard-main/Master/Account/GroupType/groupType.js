...
function GroupType() {
    ...
    return ( <div>
        ...
        <div className='row  px-4 py-2'>
            ...
            <div className='d-flex justify-content-between align-item-center bottom-border py-1'>  <h5 className=' table-heading align-item-center'>GROUP TYPE</h5>
            <div className='btn-group-sm '>
                <Link to={'/grouptypef2'}className='btn green fw-bold' style={{borderTopRightRadius:'0px' ,borderBottomRightRadius:'0px'}}><i class="bi bi-plus-circle-fill px-2"></i>ADD</Link>
                <Link to={'/grouptypef2'} className='btn btn-light fw-bold'>F2</Link>
                </div>
                </div>
            </div>
            <div className=''>
