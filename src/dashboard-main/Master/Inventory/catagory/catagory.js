...
function Category() {
    ...
    const statusCellRenderer = (rowIndex) => (
        <Cell style={{fontSize:'17px'}} >{`DEACTIVE`}</Cell>
    );
    ...
    return ( <div>
        ...
        <div className='row  px-4 py-2'>
            ...
            <div className='col-12 '>
            <div className='d-flex justify-content-between align-item-center bottom-border py-1'>  <h4 className=' table-heading align-item-center'>SUPPLIER MASTER</h4>
            <div className='btn-group-sm '>
                <Link to={'/categoryf2'}className='btn green fw-bold' style={{borderTopRightRadius:'0px' ,borderBottomRightRadius:'0px'}}><i class="bi bi-plus-circle-fill px-2"></i>ADD</Link>
                <Link to={'/categoryf2'} className='btn btn-light fw-bold'>F2</Link>
                </div>
                </div>
            </div>
            <div className=''>
         ...
         <Table numRows={10} enableRowHeader={false} rowHeights={[37,37,37,37,37,37,37,37,37,37,]} columnWidths={[1300,250,380]} >
