        ...
        <div className="col-md-8 col-12">
          <div className="card full-border">
            <div className="card-body">
              <h5 className="title">NEW BRAND</h5>
              <div className="row">
                <h5 className="sub-title">GENERAL DETAIL</h5>

                <div className="col-md-6 col-12">
                  <div className="row fw-bold text-size-15px">
                    <div className="fw-bold col-md-6 col-12 mt-1">BRAND <span className="text-danger">*</span></div>
                    <input placeholder="" className="col-md-6 col-12 mt-1" />
                    <div className="fw-bold col-md-6 col-12 mt-1"> UNDER BRAND</div>
                    <input placeholder="" className="col-md-6 col-12 mt-1" />
                ...
                <div className="col-md-6 col-12">
                  <div className="row fw-bold text-size-15px">
                    ...
                    <div className="col-md-6 col-12 mt-1">ACTIVE</div>
