    ...
    return ( <div>
        ...
        <div className='row  px-4 py-2'>
            ...
            <div className='btn-group-sm '>
                <Link to={'/groupInventoryf2'}className='btn green fw-bold' style={{borderTopRightRadius:'0px' ,borderBottomRightRadius:'0px'}}><i class="bi bi-plus-circle-fill px-2"></i>ADD</Link>
                <Link to={'/groupInventoryf2'} className='btn btn-light fw-bold'>F2</Link>
                </div>
                </div>
            </div>
            <div className=''>
         ...
         <Table numRows={10} enableRowHeader={false} rowHeights={[37,37,37,37,37,37,37,37,37,37,]} columnWidths={[800,250,280,]} >
